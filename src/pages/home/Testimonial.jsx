...
const Testimonial = () => {
  ...
  return (
    <div className="relative lg:block hidden">
      ...
      <section className="p-6 bg-sky-700 dark:text-gray-800">
        <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
          <div className="flex p-4 border bg-slate-300 text-gray-600 hover:bg-blue-950 hover:text-white space-x-4 rounded-lg md:space-x-6 ">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl font-semibold leading-none">
                <CountUp end={2480} duration={5} delay={2}></CountUp>
              </p>
          ...
          <div className="flex p-4  border bg-slate-300 text-gray-600 hover:bg-blue-950 hover:text-white space-x-4 rounded-lg md:space-x-6 ">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl font-semibold leading-none">
                <CountUp end={7856} duration={5} delay={2}></CountUp>
              </p>
              <p className="capitalize">Happy Smiles</p>
            </div>
          </div>
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6  border bg-slate-300 text-gray-600 hover:bg-blue-950 hover:text-white">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-violet-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl font-semibold leading-none">
                <CountUp end={38} duration={2} delay={2}></CountUp>
              </p>
          ...
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6  border bg-slate-300 text-gray-600 hover:bg-blue-950 hover:text-white">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl font-semibold leading-none">
                <CountUp end={76} duration={2} delay={2}></CountUp>
              </p>
