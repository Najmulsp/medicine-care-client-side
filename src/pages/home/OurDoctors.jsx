...
const OurDoctors = () => {
    return (
        <div>
            <section className="py-6 s bg-base-200 dark:text-gray-800">
	<div className="container p-6 mx-auto space-y-8">
		...
		<div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
			<article className="flex flex-col hover:bg-blue-950 hover:text-white">
			...
			<article className="flex flex-col hover:bg-blue-950 hover:text-white border border-gray-300 border-t-gray-100">
				<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
			...
			<article className="flex flex-col hover:bg-blue-950 hover:text-white border border-gray-300 border-t-gray-100">
				<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum">
					<img alt="" className="object-cover w-full h-52 " src={doctor4} />
				</a>
				<div className="flex flex-col flex-1 p-6">
					<a rel="noopener noreferrer" href="#" aria-label="Te nulla oportere reprimique his dolorum"></a>
					...
					<h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Te nulla oportere reprimique his dolorum</h3>
                    <hr className="w-full mt-2 mb-2"/>
					<div className="flex flex-wrap items-center pt-3 space-x-6 text-xs ">
						<span><MdPhoneAndroid /></span>
						<span>+1-212-333-7078</span>
